...
За да успеете да подкарате приложението, то изисква да разполагате и със статичното съдържание за всяка забележителност. То е налично тук чрез `submodule` функционалността на Git и е позиционирано в директорията `/resources/static`. Промените във файловете обаче се извършват от [static-contents](https://github.com/placesbg/static-contents) хранилището и впоследствие се синхронизират тук, така че не правете промени директно от това приложение.
