    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow overflow-hidden sm:rounded-lg">
                <h2 class="mb-6 text-xl font-semibold leading-none text-gray-900 md:text-2xl">{{ $region->title }}</h2>
                ...
                <div class="flex justify-between gap-5 mb-5">
                    <dl class="block w-full">
                        ...
                        <dd class="font-light leading-none text-gray-500">{{ $region->slug }}</dd>
                    </dl>

                    <dl class="block w-full">
                        <dt class="mb-2 font-semibold leading-none text-gray-900">{{ __('form.label.color') }}</dt>
                ...
                <dl>
                    ...
                    <dd class="mb-4 font-light leading-tight text-gray-500 sm:mb-5">{{ $region->description }}</dd>
                </dl>
