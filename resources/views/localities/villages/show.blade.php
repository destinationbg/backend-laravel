    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow overflow-hidden sm:rounded-lg">
                <h2 class="mb-6 text-xl font-semibold leading-none text-gray-900 md:text-2xl">{{ $village->name }}</h2>
                ...
                <div class="flex justify-between gap-5 mb-5">
                    <dl class="block w-full">
                        ...
                        <dd class="font-light leading-none text-gray-500">{{ $village->slug }}</dd>
                    </dl>

                    <dl class="block w-full">
                        <dt class="mb-2 font-semibold leading-none text-gray-900">{{ __('form.label.code_municipality') }}</dt>
                        <dd class="font-light leading-none text-gray-500">{{ $village->code }}</dd>
                    </dl>

                    <dl class="block w-full">
                        <dt class="mb-2 font-semibold leading-none text-gray-900">{{ __('form.label.code_ekatte') }}</dt>
                        <dd class="font-light leading-none text-gray-500">{{ $village->ekatte }}</dd>
                    </dl>
                </div>

                <dl>
                    <dt class="mb-2 font-semibold leading-none text-gray-900">{{ __('form.label.description') }}</dt>
                    <dd class="mb-4 font-light leading-tight text-gray-500 sm:mb-5">{{ $village->description }}</dd>
                </dl>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    {{ html()->form('DELETE', route('villages.destroy', $village))->open() }}
                    <button type="submit"
                    ...
                    <a href="https://www.nsi.bg/nrnm/ekatte/territorial-units?ekatte=&t_v_m=%D1%81." target="_blank"
                        rel="noopener"
                        ...
                        <span>{{ __('button.nsi_villages') }}</span>
                    </a>
                </div>
            </div>
        </div>
